  ...
  return (
    <div className='container mx-auto px-4 py-16'>
      <section className="text-center mb-20">
        <AnimatedGlobe />
        <h1 className="text-7xl font-bold mb-6 text-gray-800 tracking-tight">
          GreenCop <span className="text-green-600">Keep Clean & Go Green</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Join our community in making the world a better place by keeping it clean and green.
        </p>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="CO2 Offset" value={`${50} kg`} icon={LeafyGreen} />
        </div>
      </section>
    </div>
  )
